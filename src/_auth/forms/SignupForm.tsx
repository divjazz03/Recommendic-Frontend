...
const SignupForm: React.FC = () => {
  ...
  function AccountForm() {
    ...
    const handleAccountFormSubmit = async (
      form: z.infer<typeof accountFormValidation>,
    ) => {
      ...
      try {
        switch (fullFormData.typeOfUser) {
          case "Patient":
            await onSubmitForPatient(fullFormData);
            break;
          case "Consultant":
            await onSubmitForConsultant(fullFormData);
            break;
        }
                  ...
                  <FormControl>
                    <Controller
                      ...
                      render={({ field }) => (
                        ...
                        >
                          <FieldLabel htmlFor="typeOfUser">
                            <Field orientation={"horizontal"}>
                              <FieldContent>
                                <FieldTitle>Patient</FieldTitle>
                                <FieldDescription>
                                  Benefit from our top team of competent medical
                                  practitioners
                                </FieldDescription>
                              </FieldContent>
                              <RadioGroupItem value="Patient" id="typeOfUser" />
                            </Field>
                          </FieldLabel>
                          <FieldLabel htmlFor="typeOfUser">
                            <Field orientation={"horizontal"}>
                              <FieldContent>
                                <FieldTitle>Consultant</FieldTitle>
                                <FieldDescription>
          ...
          <div className="flex justify-center flex-col mt-4 gap-2 mb-2 w-full">
            {step != 1 && (
              <Button
                type="button"
                variant="secondary"
                className="shad-button_secondary text-dark-4"
      ...
      <div className="flex flex-col p-8 items-center justify-center w-full">
        <header className="mb-5">
          ...
          <p className=" text-sm text-gray-600 text-center">
            Lets get you started with recommendic
          </p>
        </header>
        ...
        <p className="text-sm font-semibold text-center mt-4">
          ...
          <span className="mx-1 text-gray-500 hover:text-dark-1">
            <Link
              to="/sign-in"
              className="subtle-semibold hover:no-underline underline"
            >
              Sign In
            </Link>
          </span>
