...
const SecurityAndPrivacy = ({
  ...
  <div className="bg-white shadow-sm p-4 sm:p-6 rounded-lg ">
    ...
    <div>
      <h3 className="font-medium font-lg text-gray-900 mb-4">
        Security Settings
      </h3>
      <div className="flex flex-col gap-3 mb-6">
        <div>
          ...
          <select
            ...
            onChange={(e) =>
              handleSettingChange("sessionTimeoutMin", e.target.value)
            }
          ...
          <button
            onClick={() =>
              handleSettingChange(
                ...
                !securitySettings["multiFactorAuthEnabled"],
              )
            }
            ...
            <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
              <div>
                ...
                <p className="text-xs text-gray-600">
                  Chrome on Windows • Ibadan, Nigeria
                </p>
    ...
    <h4 className="font-medium font-lg text-gray-900 pb-4 mb-2 border-b">
      Privacy Settings
    </h4>
    <div className="flex flex-col gap-4 mb-2">
      ...
      <div className="flex items-center justify-between">
        ...
        >
          <span
            className={`inline-block h-4 w-4 transform rounded-full bg-white transition-transform ${securitySettings["loginAlertsEnabled"] ? "translate-x-6" : "translate-x-1"}`}
          />
        </button>
      </div>
    </div>
