...
const ConsultantWaitingScreen = ({
  ...
  const [consultation, setConsultation] = useState<ConsultationPreview>({
    id: "N/A",
    patientName: "N/A",
    patientAge: "N/A",
    patientGender: "N/A",
  ...
  useEffect(() => {
    ...
    setConsultation({
      ...
      patientGender: data.patientData?.gender ?? "N/A",
      patientAge: data.patientData?.age ?? "N/A",
      patientHistory: [],
  ...
  const handleEndSession = () => {
    if (
      confirm(
        "Are you sure you want to end this consultation session? The patient has not joined yet.",
      )
    ) {
  ...
  const handleCallPatient = () => {
    alert("Sending alert to patient...");
  };
          ...
          <div className="bg-green-500 text-white rounded-lg shadow-md p-4 mb-6 flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <p className="font-semibold">
                Patient has been notified and can now join the consultation
              </p>
            </div>
            <button
            ...
            <div className="flex flex-col sm:flex-row text-center sm:text-start items-center gap-4">
              ...
              <div className="flex-1 flex flex-col">
                ...
                <p className="text-gray-600">
                  The patient has been notified and can join at any moment
                </p>
              </div>
              <Button
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-amber-800">
                    If the patient doesn't join within 5 minutes, consider
