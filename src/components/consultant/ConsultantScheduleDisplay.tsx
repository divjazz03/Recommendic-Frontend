...
import {
  ...
  formatTime,
  useScheduleDisplay,
} from "@/hooks/useConsultantSchedule";
        ...
        <div className="flex items-center justify-between mb-8">
          <div>
            ...
            <p className="text-sm sm:text-base text-gray-600">
              Manage your consultation availability and channels
            </p>
          </div>
                      ...
                      {schedule.recurrenceRule && (
                        <div className="mb-4 p-3 bg-gray-50 rounded-lg">
                          <div className="flex items-center gap-2 text-sm text-main">
                            ...
                            <span>
                              {formatRecurrence(schedule.recurrenceRule)}
                            </span>
                          </div>
                      ...
                      <div className="mb-4">
                        ...
                        <div className="flex flex-wrap gap-2">
                          {schedule.channels.map((channel) => {
                            const channelOption =
                              ChannelOptions[
                                channel.toLowerCase() as keyof typeof ChannelOptions
                              ];
            ...
            {schedules?.length === 0 && (
              ...
              <Empty>
                <EmptyHeader>
                  ...
                  <EmptyDescription>
                    Create your first schedule to start accepting consultations
                  </EmptyDescription>
                  <EmptyContent>
                    <Button onClick={handleCreateNewSchedule}>
                      Create Schedule
