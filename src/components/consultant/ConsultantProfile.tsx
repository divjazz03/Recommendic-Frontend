...
import {
  ...
  ModifyingConsultantProfileData,
...
const ConsultantProfile = () => {
  ...
  } = useConsultantProfile(accessToken);
      ...
      <div className="max-w-7xl mx-auto sm:px-4 lg:px-8 sm:py-6">
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
          ...
          <div className="lg:col-span-3">
            ...
            {activeTab === "profile" &&
              (!profileData ? (
                <p>Couldn't retrieve profile data</p>
              ) : (
                <ProfileInformation
            ...
            {activeTab === "notifications" && (
              <NotificationPreference
                consultantNotificationSettings={notificationSettings}
                handleNotificationChange={handleNotificationChange}
                notificationSettingsHasBeenModified={
                  isEditing ? notificationSettingsHasBeenModified : () => false
                }
                handleSaveModification={handleSaveProfile}
                setActiveTab={setActiveTab}
              />
            )}
            {/* Privacy Settings */}
        ...
        <div className="flex items-start justify-between">
          <div className="flex items-center gap-2">
            ...
            <div>
              ...
              <p className="hidden sm:block text-xs sm:text-sm font-thin text-gray-500">
      ...
      <div className="flex flex-col gap-6">
        ...
        <div className="md:col-span-2">
          ...
          <input
            ...
            onChange={(e) =>
              handleInputChange("boardCertification", e.target.value)
            }
            disabled={!isEditing}
            className="w-full px-3 py-2 text-sm border border-gray-300 rounded-lg focus:ring-2 focus:ring-main-light focus:border-main-light outline-none disabled:bg-gray-50 disabled:text-gray-500"
          />
        ...
        <div className="">
          ...
          <MultiSelect
            disabled={!isEditing}
            elements={["English", "French", "Spanish"]}
            handleElementsChange={handleLanguagesChange}
            selectedElements={profileData?.languages ?? []}
        ...
        {[
          ...
          >
            ...
            <button
              onClick={() =>
                handleNotificationChange(
                  setting.key as keyof ConsultantNotificationSetting,
                )
              }
