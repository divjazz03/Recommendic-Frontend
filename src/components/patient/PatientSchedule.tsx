...
export const PatientSchedule = () => {
  ...
  const consultantId: string = param.consultantId;
      ...
      <div className="h-full bg-gray-50 p-4">
        <div className="max-w-2xl mx-auto pt-20">
          <div className="bg-white rounded-3xl shadow-2xl p-8 text-center">
            ...
            <h2 className="text-3xl font-bold text-dark-3 mb-4">
              Booking Confirmed!
            </h2>
            <p className="text-gray-600 mb-6">
              Your consultation with Dr. Sarah Mitchell has been successfully
              scheduled.
            </p>
      ...
      <div className="max-h-[800px] h-full bg-gray-50 p-4">
        <div className="max-w-2xl mx-auto pt-20">
          <div className="bg-white rounded-3xl shadow-2xl p-8 text-center">
            ...
            <h2 className="text-2xl font-bold text-dark-3 mb-4">
  ...
  return (
    <section className="h-full p-4 ">
      <div
        className="flex flex-col h-full max-w-3xl mx-auto overflow-auto scroll-smooth
      ...
      >
        <header className="flex items-center gap-4 mb-4 sticky top-0 bg-transparent backdrop-blur-[2px]">
          ...
          <div>
            <h1 className="text-3xl font-bold text-dark-3">
            ...
            {isPending ? (
              ...
              <p className="text-dark-1">
                Book a consultation with {consultantScheduleData?.fullName}
              </p>
            )}
          </div>
        </header>
              ...
              <div className="flex-1">
                <div className="flex items-center gap-2 mb-1">
                  <h3 className="text-xl font-semibold text-dark-3">
                    {consultantScheduleData?.fullName}
                  </h3>
            ...
            <div className="">
              ...
              {selectedDate && (
                <div className="bg-white rounded-2xl shadow-sm border p-6">
                  <h2 className="text-xl font-semibold text-dark-3 mb-4">
                    Available Times
                  </h2>
                ...
                <div className="space-y-3">
                  {consultationTypes.map((type) => (
                    <div
                      key={type.id}
                      onClick={() =>
                        setConsultationType(type.id as ConsultationChannel)
                      }
                      className={`
                        ...
                        `}
                          ...
                          <div className="flex-1">
                            <div className="flex items-center justify-between mb-1">
                              <h3 className="font-medium text-dark-3">
                                {type.name}
                              </h3>
                  ...
                  <div className="space-y-4">
                    <div className="flex items-center gap-3 p-3 bg-gray-50 rounded-lg">
                      ...
                      <div>
                        ...
                        <div className="text-sm text-gray-600">
                          {DateTime.fromISO(selectedTime).toFormat("hh:mm a")}
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="border-t pt-4">
                      <div className="flex items-center justify-between mb-4">
                        <span className="text-lg font-medium text-dark-3">
                          Total
                        </span>
                    ...
                    <div className="flex items-start gap-2 p-3 bg-blue-50 rounded-lg">
                      ...
                      <div className="text-sm text-main">
                        ...
                        <p>
                          You can reschedule or cancel up to 2 hours before your
                          appointment.
                        </p>
                      </div>
                    </div>
