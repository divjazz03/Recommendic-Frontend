...
const PatientRootLayout = () => {
	...
	return (
		<main className='relative bg-light-4 min-w-[320px] max-w-full h-full overflow-hidden'>
			<div className='border-2 flex flex-col h-full'>
								...
								<ul>
									<li>
										<Link to={"/patient/overview"}>
											<div className={`flex flex-row gap-2 side-bar-li ${location.pathname.includes('/patient/overview')? 'bg-main text-light-4':''}`}>
									...
									<li>
										<Link to={"/patient/consultant"}>
											<div className={`flex flex-row gap-2 side-bar-li ${location.pathname.includes("/patient/consultant")|| location.pathname.includes('/patient/schedule')?'bg-main text-light-4':''}`}>
									...
									<li >
										<Link to={"/patient/chat"}>
											<div className={`flex flex-row gap-2 side-bar-li ${location.pathname.includes("/patient/chat") ?'bg-main text-light-4':''}`}>
									...
									<li >
										<Link to={"/patient/medication"}>
											<div className={`flex flex-row gap-2 side-bar-li ${location.pathname.includes("/patient/medication") ?'bg-main text-light-4':''}`}>
								...
								<ul>
									<li >
										<Link to={"/patient/notification"}>
											<div className={`flex flex-row gap-2 side-bar-li ${location.pathname.includes("/patient/notification") ?'bg-main text-light-4':''}`}>
												<div className='relative block max-w-fit max-h-fit'>
									...
									<li>
										<Link to={"/patient/settings"}>
											<div className={`flex flex-row gap-2 side-bar-li ${location.pathname.includes("/patient/settings") ?'bg-main text-light-4':''}`}>
				...
				<div className='lg:flex lg:flex-row w-full h-screen'>
					...
					<section className='w-full h-full mb-3 flex flex-col'>
						<div className='hidden w-full min-h-12 py-3 bg-white lg:flex flex-row justify-end mx-auto '>
							<GlobalSearch />
						</div>
						<Outlet />
					</section>
