...
import { Calendar, Clock, Video, Phone, MessageCircle, Users, Edit, Plus, Eye, EyeOff, Settings } from 'lucide-react';
                  ...
                  <div className="mb-4">
                    ...
                    <div className="flex flex-wrap gap-2">
                      {schedule.channels.map(channel => {
                        const channelInfo = channelOptions[channel.toLowerCase()];
